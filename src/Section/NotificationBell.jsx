    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button onClick={() => setOpen(o => !o)}
                className="relative w-9 h-9 flex items-center justify-center rounded-lg  text-white hover:text-gray-200 transition-colors cursor-pointer">
            ...
            {/* Dropdown */}
            {open && (
                <div className="absolute right-0 top-11 w-80 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden z-50">
