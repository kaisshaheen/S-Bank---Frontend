        ...
        <div className="min-h-screen bg-gray-50 py-6 px-4 sm:px-6">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-4">
                    <p className="text-lg font-semibold text-gray-900">Account statement</p>
                    <button onClick={handlePdfDownload} disabled={pdfLoading}
                        className="flex items-center gap-1.5 text-xs sm:text-sm px-3 py-1.5 rounded-lg border border-red-200 text-red-600 hover:bg-red-50 transition-colors disabled:opacity-40">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-5 mb-4 shadow-sm">
                    ...
                    <div className="flex justify-end">
                        <button onClick={fetchStatement}
                            className="w-full sm:w-auto text-sm px-4 py-2.5 rounded-xl border border-blue-200 text-blue-700 hover:bg-blue-50 transition-colors">
                            Apply filters
                        </button>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-5 mb-4 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
                        ...
                        <button onClick={handlePdfDownload} disabled={pdfLoading}
                            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl border border-red-200 text-red-600 text-sm hover:bg-red-50 transition-colors disabled:opacity-40">
                            <svg width="13" height="13" viewBox="0 0 16 16" fill="none">
                                <path d="M8 2v8M5 7l3 3 3-3M3 13h10" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                ...
                <div className="hidden sm:block bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    ...
                    <div className="grid grid-cols-4 px-4 py-2.5 border-b border-gray-100 gap-2">
                    ...
                    {loading ? (
                        ...
                        <div key={txn.id}
                            ...
                            <p className="text-xs text-right text-gray-400 m-0">
                                {new Date(txn.created_at).toLocaleDateString('en', { day: '2-digit', month: 'short', year: 'numeric' })}
                            </p>
                        </div>
                    ))}
                </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                        ...
                        {loading ? (
                            ...
                            <div key={txn.id}
                                ...
                                <p className={`text-sm font-semibold flex-shrink-0 ${amountColor[txn.type]}`}>
                                    {signs[txn.type]}${Number(txn.amount).toLocaleString('en', { minimumFractionDigits: 2 })}
                                </p>
                            </div>
                        ))}
