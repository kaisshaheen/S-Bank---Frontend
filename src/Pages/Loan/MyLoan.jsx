...
const MyLoan = () => {
    ...
    if (loading) return (
        <div className="flex items-center justify-center mt-40 text-sm text-gray-400">
            Loading loan...
        </div>
    )
    ...
    if (!loan) return (
        <div className="max-w-md mx-auto mt-16 px-4 text-center">
            <p className="text-sm text-gray-400 mb-3">You don't have an active loan.</p>
        </div>
    )
    ...
    return (
        <div className="max-w-xl mx-auto mt-10 px-4">
            ...
            <div className="flex items-center justify-between mb-4">
                <p className="text-lg font-medium text-gray-900">My loan</p>
            ...
            {success && (
                <p className="text-sm text-green-600 bg-green-50 rounded-lg px-4 py-2 mb-4">{success}</p>
            )}
            {error && (
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mb-4">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                    {[
                        ['Loan amount',        `$${Number(loan.amount).toLocaleString('en', { minimumFractionDigits: 2 })}`],
                        ['Total payable',      `$${Number(loan.total_payable).toLocaleString('en', { minimumFractionDigits: 2 })}`],
                    ...
                    return (
                        <div key={inst.id}
                            ...
                            <span className="text-gray-700">
                                {new Date(inst.due_date).toLocaleDateString('en', {
